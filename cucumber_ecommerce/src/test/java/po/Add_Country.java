...
public class Add_Country {
	...
	WebDriver driver;
	public Add_Country(WebDriver driver) {
	...
	@CacheLookup
	WebElement country_mainpage;
	
	@FindBy(xpath="//div[@class=\"pull-right\"]//a")
	@CacheLookup
	WebElement add_country_btn;
	...
	public void Enter_country(String text) {
		try {
			Thread.sleep(2000);
			country_mainpage.sendKeys(text);
		}catch(Exception ex) {
			ex.printStackTrace();
		}
	} 
